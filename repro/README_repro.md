...
- Additional tables: `ed_vs_baseline_internal_eval.json`
...
- `verify_eigenmode_holdout.py` – checks the frozen ex-ante local eigenmode holdout against the aggregated clock-spectroscopy rows.
